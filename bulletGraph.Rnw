...
tikz(file="build/custSatifaction.tex",width=1.6,height=0.53)
...
\textbf{Revenue}\newline\small{ US \$  (1,000)}& \raisebox{-.5\height}{\input{revenue}} \\ \hline \\
